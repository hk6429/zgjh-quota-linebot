...
function handleTextMessage(event) {
  ...
  if (userText.startsWith('#提問') || userText.startsWith('#留言') || userText.startsWith('#諮詢')) {
    ...
    const reply = `📝 結果：已登錄家長在線諮詢，註冊組會儘速查覆\n\n📋 諮詢內容\n• 諮詢單號：${orderNo}\n• 提問內容：${inquiryContent}\n• 處理狀態：已送交註冊組查核中\n\n📞 上班時間亦可致電註冊組：${CONFIG.PHONE_INFO}`;
...
function handleRememberCommand(rawText, userId) {
  try {
    ...
    return `✅ 結果：已記住並寫入 Google 試算表\n\n📋 寫入內容\n• 題目關鍵字：${question}\n• 回覆內容：${answer}\n• 儲存位置：「${CONFIG.SHEET_QA}」第 ${lastRow + 1} 列\n\n💡 下次家長提問「${question}」，小幫手會即時用這段回答`;
  } catch (err) {
...
【回覆格式，務必遵守】：純文字，不用 Markdown（不要 **、#、表格）。第一行用一個 emoji 加「結果：」先講結論；空一行後用「📋 原因」小標，底下每點以「• 」開頭條列；最後可用「📌 說明」或「💡 提示」補充。全文 300 字內。
...
${sheetSummary}`;
    ...
    const payload = {
      ...
      generationConfig: {
        ...
        // gemini-2.5 系列預設會「思考」，思考 token 也計入 maxOutputTokens，不關掉正文會被截成一句話
...
function getDefaultHelpMessage(text) {
  return `🤖 結果：這題我還沒學會，已記入待補充問題庫，註冊組會補上

📋 您可以這樣問
• 順位總覽：總量管制有哪些順位
• 順位試算：我有權狀、租約沒公證、沒有租約，各算第幾順位
• 順位差別：第四跟第五順位差在哪
• 門檻分析：設籍要滿幾年才排得上
• 攜帶文件：3/14 登記要帶什麼
• 學區查詢：北門里算竹光學區嗎
• 改分發：沒錄取會改分發到哪
• 在線提問：輸入「#提問 問題內容」立案送註冊組

📞 人工諮詢：竹光國中教務處註冊組 ${CONFIG.PHONE_INFO}`;
}
  ...
  "qa": [
    {
      ...
      "answer": "📚 結果：竹光國中 115 學年度共有六個順位\n\n🥇 第一順位：少年保護個案、列冊低收入戶子女、父母雙亡學童、本校教職員子女、市府安置資源生\n🥈 第二順位：新竹市國小畢業＋自有權狀（或 115 房屋稅籍證明）或法院公證租約\n🥉 第三順位：外縣市國小畢業＋自有權狀或法院公證租約\n4️⃣ 第四順位：只有「未經法院公證」的租約\n5️⃣ 第五順位：戶籍符合，但沒有任何居住證明\n6️⃣ 第六順位（最後順位）：不簽家訪同意書，或經查為空戶\n\n📋 原因與規則\n• 先決條件：學生設籍並實際居住學區內，且戶籍內有直系尊親屬（父母／祖父母／外祖父母）或法定監護人同戶\n• 戶籍不符者無法登記，連順位都沒有\n• 排序：先比順位，同順位再比戶籍遷入學區的時間先後\n• 第二到第五順位都要簽家訪同意書\n\n💡 想知道自己第幾順位，直接輸入「我有權狀」「租約沒公證」「沒有租約」試算",
    ...
    },
    {
      ...
      "answer": "🥇 結果：第一順位\n\n📋 適用身分（設籍本校學區者）\n• 經縣市政府轉介安置的少年保護個案\n• 設籍本市且居住學區內、經市府列冊的低收入戶子女\n• 設籍本市且居住學區內而父母雙亡者\n• 本校現職編制內教職員工的子女、受監護人（隨父母或監護人就讀所服務學校）\n• 經市府鑑定並安置的資源生\n\n📌 說明\n• 依 115 作業規定伍、三、1\n• 除教職員子女外，學校會實地訪查是否有居住事實\n• 名單公告後新聘的教職員子女採外加名額",
    ...
    },
    {
      ...
      "answer": "🎯 結果：第二順位（新竹市國小畢業）／第三順位（外縣市國小畢業）\n\n📋 原因\n• 學生設籍並實際居住本校學區，且與直系尊親屬同戶\n• 房屋所有權狀（或 115 年度房屋稅籍證明）登記在直系尊親屬或法定監護人名下\n• 簽具家訪同意書\n\n📌 說明\n• 依 115 作業規定伍、三、2 及 3\n• 自有住宅與法院公證租約排序效力相同\n• 同順位再比戶籍遷入學區時間先後",
    ...
    },
    {
      ...
      "answer": "⚖️ 結果：第二順位（新竹市國小畢業）／第三順位（外縣市國小畢業）\n\n📋 原因\n• 有「經法院公證」的房屋租賃契約\n• 租期涵蓋 115/3/14 新生登記日至 115/9/1 開學日\n• 承租人是學生的直系尊親屬或法定監護人\n• 簽具家訪同意書\n\n📌 說明\n• 依 115 作業規定伍、三、2 及 3；Q&A 第 8 題\n• 公證租約與自有權狀排序效力相同",
    ...
    },
    {
      ...
      "answer": "📋 結果：第四順位\n\n📋 原因\n• 戶籍符合（學生設籍學區，且與直系尊親屬同戶），可以參加新生登記\n• 只有「未經法院公證」的房屋租賃契約\n• 租期涵蓋 115/3/14 至 115/9/1，承租人為直系尊親屬\n• 簽具家訪同意書\n\n📌 說明\n• 依 115 作業規定伍、三、4；Q&A 第 8 題\n• 同順位再比戶籍遷入學區時間先後\n\n💡 提示：3/14 登記前補辦法院公證，可提升為第二順位（外縣市國小為第三順位）",
    ...
    },
    {
      ...
      "answer": "📌 結果：第五順位\n\n📋 原因\n• 戶籍符合：學生設籍學區，且戶籍內有直系尊親屬或法定監護人同戶\n• 沒有任何居住證明（沒有權狀、沒有租約），或文件不符規定（承租人不是直系尊親屬、租期未涵蓋 3/14 至 9/1）\n• 簽具家訪同意書即可參加排序\n\n📌 說明\n• 依 115 作業規定伍、三、5\n• 同順位再比戶籍遷入學區時間先後\n\n💡 想提升順位\n• 補一份「未公證」租約（租期涵蓋 115/3/14 至 9/1、承租人為直系尊親屬）→ 第四順位\n• 租約再去法院公證 → 第二順位（外縣市國小為第三順位）",
    ...
    },
    {
      ...
      "answer": "🔍 結果：差別只在「居住證明文件」，戶籍條件完全一樣\n\n📋 三者對照\n• 第二順位：有完整居住證明，也就是自有權狀（或 115 房屋稅籍證明）或「法院公證」租約（外縣市國小畢業為第三順位）\n• 第四順位：只有「未經法院公證」的租約（租期涵蓋 115/3/14 至 9/1，承租人為直系尊親屬）\n• 第五順位：完全沒有居住證明（沒權狀、沒租約），或文件不符規定\n\n📌 說明\n• 三者都要：學生設籍學區＋直系尊親屬同戶＋簽家訪同意書\n• 一句話：有公證租約是第二，租約沒公證是第四，連租約都沒有是第五\n• 同順位再比戶籍遷入學區時間先後（依 115 作業規定伍、三、2 至 5）",
    ...
    },
    {
      ...
      "answer": "⚠️ 結果：第六順位（最後順位）\n\n📋 適用情形\n• 符合入學資格，但無法簽具（或不同意）家訪同意書\n• 經學校訪查已遷居學區外、非實際居住，或為空戶（人籍分離）\n\n📌 說明\n• 依 115 作業規定伍、三、6 及伍、五\n• 家訪同意書在黃單背面，請務必簽名；學校得不定期查核居住事實\n• 空戶者列第六順位並勸導轉入實際居住學區的學校\n• 戶籍內沒有直系尊親屬同戶者「無法登記」，連順位都沒有（這不是第六順位）",
    ...
    },
    {
      ...
      "answer": "📐 結果：先比順位，同順位再比戶籍遷入學區的時間\n\n📋 排序規則\n• 第一順位全部排完，才輪到第二順位，依此類推\n• 同順位者，越早設籍越優先\n• 最後一名若有二人以上同日遷入：有兄姊就讀本校者優先；條件相同則公開抽籤\n• 最後一名若為多胞胎之一：其多胞胎手足以外加名額隨同就讀\n• 超出核定名額者依序列為備取\n\n📌 說明\n• 依 115 作業規定伍、四\n• 共同學區與單一學區排序基準完全一樣\n• 自有住宅與公證租約排序效力一樣（都是第二順位）",
    ...
    },
    {
      ...
      "answer": "📊 結果：無法事先保證，要等 3/14（六）登記後排序才知道\n\n📋 歷年第四順位設籍門檻參考\n• 111 學年：設籍滿 5 年（約小二設籍）\n• 112 學年：設籍滿 4 年（約小三設籍）\n• 113 學年：設籍滿 8 年（約大班設籍）\n• 114 學年：設籍滿 2 年（約小五設籍）\n\n📌 說明\n• 每年登記人數不同，門檻隨之浮動\n• 先比順位，同順位再比設籍先後（Q&A 第 4 題；說明會 Q1）",
      "note": "Q&A Q4；簡報 Q1",
      "status": "Y"
    },
    {
      ...
      "answer": "🏡 結果：學區內搬家可累計；曾遷出學區則從最後一次遷入日重算\n\n📋 計算原則\n• 以「學生本人」戶籍遷入學區的時間起算\n• 同一學區內里鄰間搬遷（例如境福里到民富里），設籍時間可以累計\n• 中途遷出本校學區（例如遷到金雅里）再遷回，以最後一次遷入本學區的日期為設籍日\n\n📌 說明\n• 依 115 作業規定伍、二；Q&A 第 3 題\n• 戶籍資料若提供「省略記事」版本，會視為登記當天才入籍，請提供含詳細記事的謄本或戶口名簿",
    ...
    },
    {
      ...
      "answer": "🎒 結果：帶黃單、戶籍資料、居住證明；不一定要本人到場\n\n📅 時間地點\n• 115 年 3 月 14 日（六）上午 08:00 至 11:00\n• 竹光國中\n\n📋 應備文件\n• 新生入學通知單（黃單）：背面「入學登記表」與「家訪同意書」填妥並簽名\n• 戶籍資料（必要，二擇一）：三個月內戶籍謄本正本；或新式戶口名簿正本＋影本（須含現住人口及詳細記事，正本驗畢歸還）\n• 居住證明（非必要，但影響順位）：自有權狀／115 房屋稅籍證明／公證租約／未公證租約\n\n📌 說明\n• 可備妥資料委託親友到校送件\n• 未參加登記者視同放棄入學資格（說明會 Q6 至 Q8）",
    ...
    },
    {
      ...
      "answer": "⚠️ 結果：一定要有直系尊親屬同戶；只有小孩設籍無法登記\n\n📋 規定\n• 學生戶籍內至少要有一位直系尊親屬或法定監護人：爸爸、媽媽、爺爺、奶奶、外公、外婆\n• 只有學生一人設籍，或寄居非直系親屬（叔叔、阿姨）戶內，無法參加新生登記，連順位都沒有\n\n📌 說明\n• 依 115 作業規定伍、一；Q&A 第 7 題\n• 請儘速辦理直系尊親屬遷入\n• 兩位以上非兄弟姊妹的新生設籍同一戶，學校會進行居住事實查核",
    ...
    },
    {
      ...
      "answer": "🗺️ 結果：竹光國中 115 學年度學區如下\n\n📋 單一學區\n• 民富里、磐石里（全里）\n• 新雅里 1 至 18 鄰、20 至 27 鄰\n• 南勢里 1 至 6 鄰、8 至 9 鄰\n\n📋 共同學區\n• 北門里 1 至 5、7 至 10、12、13、16、17 鄰：竹光／光華／建華（115 新增）\n• 新雅里 19 鄰：竹光／虎林\n• 南勢里 10 鄰：竹光／虎林／成德\n• 客雅里 1 至 2 鄰：竹光／成德；3 至 7 鄰：竹光／虎林／成德\n• 境福里：竹光／光華\n• 文雅里：竹光／成德／光華\n• 長和里、新民里：竹光／育賢／光華\n• 中雅里 1 至 11 鄰：竹光／成德；12 至 16 鄰：竹光／虎林／成德\n\n📌 說明\n• 依 115 作業規定肆；以教育處 115 學年度學區劃分表為準\n• 共同學區與單一學區排序標準完全一致",
      "note": "作業規定肆；簡報「學區範圍」",
      "status": "Y"
    },
    {
      ...
      "answer": "⚖️ 結果：可以，但要在 115 年 3 月 12 日（四）前自行向另一所總量國中申請\n\n📋 規定\n• 共同學區若包含另一所總量管制學校（如光華、建華），家長可兩校都登記\n• 須於 3/12 前向另一所總量國中提出登記申請，逾期無法同時登記\n• 共同學區未獲錄取者，依家長意願改分發至該共同學區的他校\n\n📌 說明\n• 依說明會 Q9；115 作業規定伍、七",
      "note": "簡報 Q9；作業規定伍、七",
      "status": "Y"
    },
    {
      ...
      "answer": "🏫 結果：依家長意願改分發\n\n📋 改分發學校\n• 單一學區學生：虎林、成德、光華、育賢、建華國中（黃單背面入學登記表有轉分發勾選欄）\n• 共同學區學生：該共同學區的他校\n\n📅 時程\n• 4/15（三）前：備取遞補（電話通知）\n• 4/17（一）前：本校函送改分發名冊\n• 4/20（一）前：改分發國中寄送入學通知書\n• 5/3（六）：一般學校新生報到\n\n📌 說明\n• 依 115 作業規定伍、六至七；說明會 Q3\n• 超出名額者先列備取，有缺額依序遞補",
    ...
    },
    {
      ...
      "answer": "👥 結果：同日遷入先看兄姊，再抽籤；多胞胎手足外加名額\n\n📋 規定\n• 最後一名若有二人以上同日遷入學區：有兄姊就讀本校者優先\n• 條件相同者：公開抽籤決定\n• 最後一名錄取學生若為多胞胎之一：其多胞胎手足隨同該生以外加名額就讀本校\n\n📌 說明\n• 依 115 作業規定伍、四",
      "note": "作業規定伍、四",
      "status": "Y"
    },
    {
      ...
      "answer": "🔄 結果：學期中只能轉出、不能轉入；出國不能保留學籍\n\n📋 規定\n• 總量限制學校學期中各年級僅得轉出，不得轉入（特殊理由經入學審查委員會或市府核准者除外）\n• 學生赴國外或大陸地區就學應辦理轉出，無法保留學籍\n• 學期中轉出的缺額，於寒假及暑假辦理補實，志願轉入學生按戶籍遷入時間先後公開分發\n• 中輟生學籍保留原校，得依規定復學\n\n📌 說明\n• 依 115 作業規定陸",
      "note": "作業規定陸",
      "status": "Y"
    },
    {
      ...
      "answer": "📅 結果：3/23（一）16:00 放榜；3/30 至 4/4 線上報到\n\n📋 115 學年度重要時程\n• 3/6（五）前：透過國小寄發新生入學通知單（黃單）\n• 3/12（四）前：共同學區欲同時登記另一所總量國中者提出申請\n• 3/14（六）08:00 至 11:00：新生入學現場登記（資格審核）\n• 3/23（一）16:00：公布錄取名冊、候補名冊、未錄取名冊（校網首頁及警衛室）\n• 3/30（一）至 4/4（六）：正取生線上報到\n• 4/7（二）至 4/8（三）：未線上報到者至警衛室實體報到（擇一即可）\n• 4/15（三）前：缺額候補遞補（電話通知）\n• 4/17（一）前：函送改分發名冊；4/20（一）前改分發國中寄通知\n• 5/30（六）09:00 至 11:30：新生入學測驗（創意樓，當日發暑假作業）\n\n📌 說明\n• 依 115 作業規定柒；說明會「重要日程統整」",
    ...
    },
    {
      ...
      "answer": "ℹ️ 結果：115 學年度預計招收 12 班\n\n📋 基本資訊\n• 什麼是總量管制：入學需求超過校舍容量，依市府核定實施班級總量限制，新生依順位與設籍時間排序錄取，額滿改分發他校\n• 承辦單位：教務處註冊組\n• 諮詢專線：(03) 524-6683 分機 613\n• 學校地址：新竹市北區和平路 1 號\n• 官方網站：https://www.zgjh.hc.edu.tw\n\n📌 說明\n• 依 115 作業規定貳、參；Q&A 第 4 題",
      "note": "作業規定貳、參；Q&A Q4",
      "status": "Y"
    },
    {
      "id": 21,
      "category": "順位判定",
      "keywords": "租房,租屋,租的,承租,房東,租賃,租約,-公證,-沒有租約,-沒租約,-無租約,-沒有租賃,-沒有租屋證明",
      "question": "我們是租房子的，算第幾順位？",
      "answer": "🏠 結果：租屋者可以登記，順位看租約狀態\n\n📋 三種情況\n• 有「法院公證」租約：第二順位（外縣市國小畢業為第三順位）\n• 只有「未公證」租約：第四順位\n• 沒有租約，或租約不符規定：第五順位\n\n📌 說明\n• 先決條件：學生設籍學區＋直系尊親屬同戶＋簽家訪同意書\n• 租約條件：租期涵蓋 115/3/14 至 115/9/1，承租人為學生的直系尊親屬或法定監護人\n\n💡 再告訴我「有公證」「沒公證」或「沒有租約」，我幫您精確判定",
      "note": "作業規定伍、三、2～5；Q&A Q8",
      "status": "Y"
    }
  ],
